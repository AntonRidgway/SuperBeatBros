/**
 * GameFrame.java provides the framework for the game, managing the render and
 * state update loops, taking care of the graphics implementation and the game
 * input (from both mouse and keyboard), and specifying several abstract methods
...
public abstract class GameFrame extends JFrame implements Runnable
{
	...
	protected ScoreTable scoreTable; //the object to load, manage, and save the high scores
	...
	private Color bkgrndColor= new Color(72, 244, 255);
	 ...
	 * Note that the background color is specified here.
	 */
	private void gameRender(Graphics gScr)
	{
		// clear the background
		gScr.setColor(bkgrndColor);
	...
	/**
	 * gameUpdate updates the game state, while the
	 * game is ongoing and not paused.
	 */
	...
	// Note that this method is not used in this version of the game. 
	...
	/**
	 * This is called when a click is finished, no default behavior
	 */
	...
	/**
	 * This is called when certain keys are pressed, handling
	 * player keyboard input.
	 */
	protected abstract void keyPressGame(int num);
