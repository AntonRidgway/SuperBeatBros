...
// Audio input stream method adapted slightly for Super Beat Bros.
...
public class ClipInfo implements LineListener
{
  ...
  private void loadClip(String fnm)
  {
    try {
      ...
      System.out.println( getClass() + "/" + fnm );
      ...
      System.out.println("Unsupported audio file: " + fnm + "-- " + audioException);
    }
    catch (LineUnavailableException noLineException) {
      System.out.println("No audio line available for : " + fnm + "-- " + noLineException);
    }
    catch (IOException ioException) {
      System.out.println("Could not read: " + fnm + "-- " + ioException);
    }
    catch (Exception e) {
      System.out.println("Problem with " + fnm + "-- " + e);
    }
  } // end of loadClip()
